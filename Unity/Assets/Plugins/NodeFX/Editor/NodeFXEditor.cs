...
public class NodeFXEditor : Editor {
    ...
    private const string NodeFX_LOGO_PATH = "Assets/Plugins/NodeFX/Resources/nodefx_logo.png";
	...
	private void GenerateStyles() {
		...
		headerStyle.normal.background = AssetDatabase.LoadAssetAtPath<Texture2D>(NodeFX_LOGO_PATH);
	}
} 
